...
export default function LoginWargaPage() {
  ...
  const [roleTab, setRoleTab] = useState('Warga');
          ...
          {['Warga', 'Admin'].map(tab => (
            <button
              ...
              style={{
                ...
                borderRadius: '30px',
                border: 'none',
                background: roleTab === tab ? '#6B8F5E' : 'transparent',
                color: roleTab === tab ? 'white' : '#666',
                fontWeight: '600',
                fontSize: '13px',
                cursor: 'pointer',
                fontFamily: "'Poppins', sans-serif",
      ...
      <div style={{
        ...
        <form onSubmit={e => e.preventDefault()}>
          ...
          <button type="button" style={{
            width: '100%', background: 'white', border: '1.5px solid #ddd', borderRadius: '30px',
          ...
          <button type="button" style={{
            width: '100%', background: '#1877F2', color: 'white', border: 'none', borderRadius: '30px',
            padding: '12px', fontSize: '14px', fontWeight: '500', cursor: 'pointer',
            fontFamily: "'Poppins', sans-serif",
            display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px',
          }}>
        ...
        <p style={{ textAlign: 'center', fontSize: '13px', color: '#666', marginTop: '1.5rem' }}>
          ...
          <span onClick={() => navigate('/register')} style={{ color: '#6B8F5E', fontWeight: '600', cursor: 'pointer' }}>
            Daftar akun
          </span>
        </p>
      </div>
