    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: "18px" }}>
          ...
          <input value="Zalvia Inasya" readOnly style={inputStyle} />
        </div>

        <div style={{ marginBottom: "18px" }}>
          <div style={{ color: "white", marginBottom: "8px" }}>Email</div>
          <input value="zalviainasyazulna@gmail.com" readOnly style={inputStyle} />
        </div>

        <div style={{ marginBottom: "18px" }}>
          <div style={{ color: "white", marginBottom: "8px" }}>Alamat</div>
          <input value="Jl. Darussalam" readOnly style={inputStyle} />
        </div>

        <div style={{ marginBottom: "28px" }}>
          <div style={{ color: "white", marginBottom: "8px" }}>No. HP</div>
          <input value="+62-812-3456-7890" readOnly style={inputStyle} />
        </div>

        <button
          style={btnStyle("#B7875E")}
